...
from asyncz.cli.commands.doctor import doctor
from asyncz.cli.commands.inspect import inspect_task
from asyncz.cli.commands.instances import instances
...
from asyncz.cli.commands.update import update
...
asyncz_cli.add_command(doctor)
asyncz_cli.add_command(instances)
